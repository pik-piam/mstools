...
R package **mstools**, version **0.2.2**
...
Bodirsky B, Humpenoeder F, Dietrich J, Stevanovic M, Weindl I, Karstens K, Wang X, Mishra A, Beier F, Breier J, Yalew A, Chen D, Biewald A, Wirth S, von Jeetze P, Crawford M, Alves M (2021). _magpie4: MAgPIE outputs R package for MAgPIE version 4.x_. doi: 10.5281/zenodo.1158582 (URL: https://doi.org/10.5281/zenodo.1158582), R package version 1.104.2, <URL: https://github.com/pik-piam/magpie4>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.104.2},
